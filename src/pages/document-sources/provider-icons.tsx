...
export function DropboxIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 43 40" className={className} aria-hidden="true">
      <path
...
export function GmailIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 49.4 37.4" className={className} aria-hidden="true">
      <path d="M3.4 37.4h7.9V18.2L0 9.8v24.2c0 1.9 1.5 3.4 3.4 3.4z" fill="#4285f4" />
      <path d="M38.1 37.4H46c1.9 0 3.4-1.5 3.4-3.4V9.8L38.1 18.2z" fill="#34a853" />
      <path d="M38.1 3.4v14.8L49.4 9.8V5.1c0-4.2-4.8-6.6-8.2-4.1z" fill="#fbbc04" />
      <path d="M11.3 18.2V3.4l13.4 10 13.4-10v14.8l-13.4 10z" fill="#ea4335" />
      <path d="M0 5.1v4.7l11.3 8.4V3.4L8.2 1C4.8-1.5 0 .9 0 5.1z" fill="#c5221f" />
    </svg>
  );
}
