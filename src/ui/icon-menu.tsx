...
export function IconMenu({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-auto min-w-64 [&_[role=menuitem]]:whitespace-nowrap">
        {items.map((item) => {
          ...
          return (
            <div key={item.id}>
              ...
              <DropdownMenuItem
                className={item.destructive ? "cursor-pointer text-destructive focus:text-destructive" : "cursor-pointer"}
